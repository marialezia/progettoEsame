...
def plotInquinanti2(stato, title, name):
    ...
    plt.ylabel('Concentrazione media [ppb]')
    plt.legend()
    plt.show()
...
def subplotInquinantiScale(stato, title, name, nFile):
    ...
    ax[0].set_ylabel('Concentration media [ppb]')
    ax[0].legend()
    ...
    ax[1].set_ylabel('log(Concentrazione media [ppb])')
    ax[1].set_xscale('log')
    ax[1].set_yscale('log')
    ax[1].legend()
...
def originaleVsFiltrato(stato, statoFiltrato, title, name, filtro):
    ...
    ax[0][0].set_ylabel('Concentrazione media NO2 [ppb]')
    ax[0][1].set_xlabel('Tempo [d]')
    ax[0][1].set_ylabel('Concentrazione media O3 [ppb]')
    ax[1][0].set_xlabel('Tempo [d]')
    ax[1][0].set_ylabel('Concentrazione media SO2 [ppb]')
    ax[1][1].set_xlabel('Tempo [d]')
    ax[1][1].set_ylabel('Concentrazione media CO [ppb]')
...
def subplotFiltri(statoFiltrato1, statoFiltrato2, statoFiltrato3, statoFiltrato4, name, filtri):
    ...
    ax[0][0].set_xlabel('Tempo [d]')
    ax[0][0].set_ylabel('Concentrazione media [ppb]')
    ax[0][1].set_xlabel('Tempo [d]')
    ax[0][1].set_ylabel('Concentrazione media [ppb]')
    ax[1][0].set_xlabel('Tempo [d]')
    ax[1][0].set_ylabel('Concentrazione media [ppb]')
    ax[1][1].set_xlabel('Tempo [d]')
    ax[1][1].set_ylabel('Concentrazione media [ppb]')
...
def subplotInquinanti(stato, title, name):
    ...
    ax[0][0].set_xlabel('Tempo [d]')
    ax[0][0].set_ylabel('Concentazione media NO2 [ppb]')
    ax[0][1].set_xlabel('Tempo [d]')
    ax[0][1].set_ylabel('Concentrazione media O3 [ppb]')
    ax[1][0].set_xlabel('Tempo [d]')
    ax[1][0].set_ylabel('Concentrazione media SO2 [ppb]')
