...
def subplotfiltri(stato, statoFiltrato1, statoFiltrato2, statoFiltrato3, statoFiltrato4, filtri):
    ...
    ax[0][0].plot(stato.days, stato.no2, label= 'originale')
    ax[0][0].plot(statoFiltrato1.days, statoFiltrato1.no2, label= 'filtrato f < '+ str(filtri[0]), linewidth = 2.0)
    ax[0][1].plot(stato.days, stato.no2, label= 'originale')
    ax[0][1].plot(statoFiltrato1.days, statoFiltrato2.no2, label= 'filtrato f < '+ str(filtri[1]), linewidth = 2.0)
    ax[1][0].plot(stato.days, stato.no2, label= 'originale')
    ax[1][0].plot(statoFiltrato1.days, statoFiltrato3.no2, label= 'filtrato f < '+ str(filtri[2]), linewidth = 2.0)
    ax[1][1].plot(stato.days, stato.no2, label= 'originale')
    ax[1][1].plot(statoFiltrato1.days, statoFiltrato4.no2, label= 'filtrato f < '+ str(filtri[3]), linewidth = 2.0)
    ...
    ax[0][0].plot(statoFiltrato1.days, statoFiltrato1.o3, label= 'filtrato f < '+str(filtri[0]), linewidth = 2.0)
    ax[0][1].plot(stato.days, stato.o3, label= 'originale')
    ax[0][1].plot(statoFiltrato2.days, statoFiltrato2.o3, label= 'filtrato f < '+str(filtri[1]), linewidth = 2.0)
    ax[1][0].plot(stato.days, stato.o3, label= 'originale')
    ax[1][0].plot(statoFiltrato3.days, statoFiltrato3.o3, label= 'filtrato f < '+str(filtri[2]), linewidth = 2.0)
    ax[1][1].plot(stato.days, stato.o3, label= 'originale')
    ax[1][1].plot(statoFiltrato4.days, statoFiltrato4.o3, label= 'filtrato f < '+str(filtri[3]), linewidth = 2.0)
    ...
    ax[0][0].plot(statoFiltrato1.days, statoFiltrato1.so2, label= 'filtrato f < '+str(filtri[0]), linewidth = 2.0)
    ax[0][1].plot(stato.days, stato.so2, label= 'originale')
    ax[0][1].plot(statoFiltrato2.days, statoFiltrato2.so2, label= 'filtrato f < '+str(filtri[1]), linewidth = 2.0)
    ax[1][0].plot(stato.days, stato.so2, label= 'originale')
    ax[1][0].plot(statoFiltrato3.days, statoFiltrato3.so2, label= 'filtrato f < '+str(filtri[2]), linewidth = 2.0)
    ax[1][1].plot(stato.days, stato.so2, label= 'originale')
    ax[1][1].plot(statoFiltrato4.days, statoFiltrato4.so2, label= 'filtrato f < '+str(filtri[3]), linewidth = 2.0)
    ...
    ax[0][0].plot(statoFiltrato1.days, statoFiltrato1.co, label= 'filtrato f < '+str(filtri[0]), linewidth = 2.0)
    ax[0][1].plot(stato.days, stato.co, label= 'originale')
    ax[0][1].plot(statoFiltrato2.days, statoFiltrato2.co, label= 'filtrato f < '+str(filtri[1]), linewidth = 2.0)
    ax[1][0].plot(stato.days, stato.co, label= 'originale')
    ax[1][0].plot(statoFiltrato3.days, statoFiltrato3.co, label= 'filtrato f < '+str(filtri[2]), linewidth = 2.0)
    ax[1][1].plot(stato.days, stato.co, label= 'originale')
    ax[1][1].plot(statoFiltrato4.days, statoFiltrato4.co, label= 'filtrato f < '+str(filtri[3]), linewidth = 2.0)
